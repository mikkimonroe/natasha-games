...
let ConnectFourComponent = class ConnectFourComponent {
    constructor() {
        this.gameBoard = {};
    ...
    ;
    isWinner(currentX, currentY, that) {
    ...
    ;
    checkDirection(currentX, currentY, direction, that) {
...
ConnectFourComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-connect-four',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./connect-four.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/games/connect-four/connect-four.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./connect-four.component.scss */ "./src/app/games/connect-four/connect-four.component.scss")).default]
    })
...
/* harmony import */ var _tictactoe_tictactoe_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tictactoe/tictactoe.component */ "./src/app/games/tictactoe/tictactoe.component.ts");
/* harmony import */ var _connect_four_connect_four_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./connect-four/connect-four.component */ "./src/app/games/connect-four/connect-four.component.ts");
...
// })
const GamesRoutingModule = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes);
...
/* harmony import */ var _tictactoe_tictactoe_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tictactoe/tictactoe.component */ "./src/app/games/tictactoe/tictactoe.component.ts");
/* harmony import */ var _connect_four_connect_four_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./connect-four/connect-four.component */ "./src/app/games/connect-four/connect-four.component.ts");
/* harmony import */ var _games_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./games-routing.module */ "./src/app/games/games-routing.module.ts");
...
GamesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _games_routing_module__WEBPACK_IMPORTED_MODULE_5__["GamesRoutingModule"]
        ]
    })
], GamesModule);
...
let TictactoeComponent = class TictactoeComponent {
    constructor(firestore) {
        ...
        firestore.doc('alerts/1').valueChanges().subscribe(alert => {
            if (!this.ignore_msg) {
                this.ignore_msg = false;
                alert(alert);
            }
    ...
    ;
    isWinner(that) {
        if (((that.board.g[0] === that.currentPlayer) && (that.board.g[1] === that.currentPlayer) && (that.board.g[2] === that.currentPlayer))
...
TictactoeComponent.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
TictactoeComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-tictactoe',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./tictactoe.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/games/tictactoe/tictactoe.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./tictactoe.component.scss */ "./src/app/games/tictactoe/tictactoe.component.scss")).default]
    })
], TictactoeComponent);
